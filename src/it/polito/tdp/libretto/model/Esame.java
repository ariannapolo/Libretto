 ...
 */
public class Esame {
	private String codice;//esiste solo in quanto descrizione di quel corso
	private String titolo;
	private String docente;
	//private Docente docente; esiste indipendentemente dal corso, ok in seguito
	...
	public boolean equals(Object obj) {
		...
		if (codice == null) {
			if (other.codice != null)
				return false;
		} else if (!codice.equals(other.codice)) //delego all'equals dell'oggetto corrispondente alla proprietà
			return false;
		return true;
	}
	/**
	 * Se l'esame non è ancora superato lo considera superato con il voto
	 * e la data specificati.
